...
// 🔵 INFO: Main page JavaScript - Effect configuration and control
// ⚪ NOTE: Handles real-time updates, configuration saving, and effect testing
...
async function loadConfig() {
  try {
    ...
    // 🔵 INFO: Update UI with loaded config
    updateUIFromConfig();
...
// ═══════════════════════════════════════════════════════════════════════════
// 🔵 INFO: Update UI Elements from Configuration
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
// 🔵 INFO: Helper Function - Set Slider Value and Update Display
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
// 🔵 INFO: Setup Real-Time Slider Update Listeners
// ═══════════════════════════════════════════════════════════════════════════

function setupSliderListeners() {
  // 🔵 INFO: Get all range inputs and add event listeners
...
// ═══════════════════════════════════════════════════════════════════════════
// 🔵 INFO: Start Real-Time Status Updates
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
// 🔵 INFO: Update System Status Display
// ═══════════════════════════════════════════════════════════════════════════
...
async function updateStatus() {
  try {
    ...
    // 🔵 INFO: Show sensor debug info if debug mode enabled
    if (config.debugMode && status.sensors) {
      const debugPanel = document.getElementById('sensorDebug');
      debugPanel.style.display = 'block';

      document.getElementById('accelMag').textContent = status.sensors.accelMagnitude.toFixed(2) + ' m/s²';
...
// ═══════════════════════════════════════════════════════════════════════════
// 🔵 INFO: Update Connection Status Indicator
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
// 🔵 INFO: Save Configuration to ESP8266
// ═══════════════════════════════════════════════════════════════════════════
...
async function saveConfig() {
  ...
  // 🔵 INFO: Disable button during save
  saveBtn.disabled = true;
  saveBtn.textContent = '💾 Saving...';

  try {
    // 🔵 INFO: Collect all form values
    const configData = {
      effects: {
        walkUp: {
    ...
    // 🔵 INFO: Send POST request to save config
    const response = await fetch('/api/config', {
      method: 'POST',
...
function showSaveStatus(message, success) {
  ...
  // 🔵 INFO: Auto-hide after 3 seconds
  setTimeout(() => {
