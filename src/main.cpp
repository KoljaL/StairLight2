...
void setup()
{
  ...
  *((volatile uint32_t *)0x60000900) &= ~(1); // Hardware WDT off
  ...
  // 🔵 INFO: Force debug mode ON (comment out to use EEPROM setting)
  // ⚪ NOTE: Useful for debugging without accessing web interface
  ...
  // ═══════════════════════════════════════════════════════════════════════
  // 🔵 INFO: Initialize I2C Bus
  // ⚪ NOTE: Required by both PCA9685 (LEDs) and MPU6050 (sensors)
  // ═══════════════════════════════════════════════════════════════════════
...
void loop()
{
  ...
  // 🔵 INFO: Check if installation mode is active
  // ⚪ NOTE: Installation mode overrides normal motion detection
  if (isBottomSensorInstallMode())
  {
    // 🔵 INFO: Bottom sensor installation mode - light all LEDs when triggered
  ...
  {
    // 🔵 INFO: Motion sensor installation mode - VU meter based on motion strength
